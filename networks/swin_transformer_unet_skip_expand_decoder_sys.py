...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=320, patch_size=4, in_chans=33, embed_dim=96, norm_layer=None):
        super().__init__()
...
class SwinTransformerSys(nn.Module):
    ...
    def __init__(self, img_size=320, patch_size=4, in_chans=33, num_classes=33,
