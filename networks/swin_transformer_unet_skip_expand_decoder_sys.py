...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=160, patch_size=4, in_chans=138, embed_dim=96, norm_layer=None):
        super().__init__()
...
class SwinTransformerSys(nn.Module):
    ...
    def __init__(self, img_size=160, patch_size=4, in_chans=138, num_classes=69,
